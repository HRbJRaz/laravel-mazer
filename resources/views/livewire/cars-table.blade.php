        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead>
                <tr>
                    ...
                    <th class="px-4 py-2">Registraion</th>
            ...
            <tbody>
                @foreach($cars as $car)
                    <tr>
                        ...
                        <td class="border px-4 py-2">{{ $car->regNo }}</td>
                        <td class="border px-4 py-2">{{ $car->cartype_id}}</td>
                        <td class="border px-4 py-2">{{ $car->location_id }}</td>
                        <td class="border px-4 py-2">{{ $car->owner_id }}</td>
                        <td class="border px-4 py-2">{{ $car->state }}</td>
                        <td class="border px-4 py-2">{{ $car->created_at->diffForHumans() }}</td>
                        <td class="border px-4 py-2">
                            <a href="" wire:click.prevent="edit({{$car}})"><i class="bi bi-pencil mr-2"></i>Edit</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
